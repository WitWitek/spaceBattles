...
public class korwetta extends przeciwnik {
	private BufferedImage image;
public korwetta(int x,int y,int szer,int wys,String src,int wd,int rOgnia,int aii) {
	
	super(x,y,szer,wys,src,wd,rOgnia,aii);
	dziala=new bron[1];
	inicjalizujDzialo(0,wd,rOgnia,50,50);
